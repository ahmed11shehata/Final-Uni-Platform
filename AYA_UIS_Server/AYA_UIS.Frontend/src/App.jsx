...
import AcademicYearResetPage from "./pages/admin/AcademicYearResetPage";
import ResetMaterialPage from "./pages/admin/ResetMaterialPage";
            ...
            <BrowserRouter>
              ...
              <Routes>
                ...
                <Route element={<ProtectedRoute allowedRoles={["admin"]}><MainLayout /></ProtectedRoute>}>
                  ...
                  <Route path="/admin/academic-year-reset" element={<AcademicYearResetPage />} />
                  <Route path="/admin/reset-material" element={<ResetMaterialPage />} />
